...
nnoremap  f :GFiles
nnoremap  g :Rg 
nnoremap  o :NERDTreeToggle:vertical res 30
nmap #   :%s////g<Left><Left>
nnoremap <silent> < :bprev
nnoremap <silent> > :bnext
xnoremap ? :'<,'>TComment
xnoremap <silent> @@ <Right>
nnoremap P $l
nnoremap Q ^
...
set laststatus=2
set mouse=a
set runtimepath=~/.vim/bundles/repos/github.com/Shougo/dein.vim/,~/.vim,/usr/local/share/vim/vimfiles,~/.vim/bundles/repos/github.com/junegunn/fzf,~/.vim/bundles/repos/github.com/neoclide/coc.nvim_release,~/.vim/bundles/repos/github.com/Shougo/dein.vim,~/.vim/bundles/repos/github.com/roxma/vim-hug-neovim-rpc,~/.vim/bundles/repos/github.com/Shougo/neoinclude.vim,~/.vim/bundles/repos/github.com/Shougo/neosnippet.vim,~/.vim/bundles/.cache/.vimrc/.dein,/usr/local/share/vim/vim82,~/.vim/bundles/.cache/.vimrc/.dein/after,/usr/local/share/vim/vimfiles/after,~/.vim/after
set scrolloff=3
set shiftwidth=4
set showcmd
set showmatch
